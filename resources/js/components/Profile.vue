              ...
              <div class="tab-content">
                ...
                <div class="tab-pane active show" id="settings">
                  <form class="form-horizontal">
                    <div class="form-group">
                      ...
                      <div class="col-sm-12">
                        <input type="" v-model="form.name" class="form-control" id="inputName" placeholder="Name"
                               required :class="{ 'is-invalid': form.errors.has('name') }">
                    ...
                    <div class="form-group">
                      <div class="col-md-12">
                        <button @click.prevent="updateInfo" type="submit" :disabled='isDisabled' class="btn btn-success">Update Profile</button>
                  ...
                  <form class="form-horizontal">
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-12">
                        <button @click.prevent="updatePassword" :disabled='isDisabled' type="submit" class="btn btn-success">Update Password
                        </button>
                      </div>
                    </div>
                  </form>
